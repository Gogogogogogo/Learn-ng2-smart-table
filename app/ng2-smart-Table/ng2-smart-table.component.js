...
var local_dataSource_1 = require('./data-source/local/local-dataSource');
var Ng2SmartTableComponent = (function () {
    ...
    Ng2SmartTableComponent.prototype.prepareSource = function () {
        if (this.source instanceof dataSource_1.DataSource) {
            return this.source;
        }
        else if (this.source instanceof Array) {
            return new local_dataSource_1.LocalDataSource(this.source);
        }
        return new local_dataSource_1.LocalDataSource();
    };
